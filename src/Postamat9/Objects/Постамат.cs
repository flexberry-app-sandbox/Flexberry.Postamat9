...
namespace IIS.Postamat9
{
    ...
    public class Постамат : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Postamat9.Статусы fСтатус;
        
        private IIS.Postamat9.СлужбаДоставки fСлужбаДоставки;
        
        private IIS.Postamat9.DetailArrayOfЯчейка fЯчейка;
        ...
        public virtual IIS.Postamat9.Статусы Статус
        {
            get
            {
                ...
                IIS.Postamat9.Статусы result = this.fСтатус;
        ...
        [PropertyStorage(new string[] {
                "СлужбаДоставки"})]
        [NotNull()]
        public virtual IIS.Postamat9.СлужбаДоставки СлужбаДоставки
        {
            get
            {
                ...
                IIS.Postamat9.СлужбаДоставки result = this.fСлужбаДоставки;
        ...
        public virtual IIS.Postamat9.DetailArrayOfЯчейка Ячейка
        {
            get
            {
                ...
                {
                    this.fЯчейка = new IIS.Postamat9.DetailArrayOfЯчейка(this);
                }
                IIS.Postamat9.DetailArrayOfЯчейка result = this.fЯчейка;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПостаматE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПостаматE", typeof(IIS.Postamat9.Постамат));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПостаматL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПостаматL", typeof(IIS.Postamat9.Постамат));
                }
            }
        }
    }
