...
namespace IIS.Postamat9
{
    ...
    public class Логистика : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Postamat9.Состояние fСостояние;
        ...
        public virtual IIS.Postamat9.Состояние Состояние
        {
            get
            {
                ...
                IIS.Postamat9.Состояние result = this.fСостояние;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЛогистикаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЛогистикаE", typeof(IIS.Postamat9.Логистика));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ЛогистикаL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЛогистикаL", typeof(IIS.Postamat9.Логистика));
                }
            }
        }
    }
