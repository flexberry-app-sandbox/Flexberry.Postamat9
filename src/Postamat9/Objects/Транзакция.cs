...
namespace IIS.Postamat9
{
    ...
    public class Транзакция : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Postamat9.Оплата fОплата;
        
        private double fСумма;
        
        private IIS.Postamat9.Пользователь fПользователь;
        ...
        public virtual IIS.Postamat9.Оплата Оплата
        {
            get
            {
                ...
                IIS.Postamat9.Оплата result = this.fОплата;
        ...
        [PropertyStorage(new string[] {
                "Пользователь"})]
        [NotNull()]
        public virtual IIS.Postamat9.Пользователь Пользователь
        {
            get
            {
                ...
                IIS.Postamat9.Пользователь result = this.fПользователь;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТранзакцияE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТранзакцияE", typeof(IIS.Postamat9.Транзакция));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ТранзакцияL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТранзакцияL", typeof(IIS.Postamat9.Транзакция));
                }
            }
        }
    }
